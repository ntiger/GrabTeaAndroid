...
import com.eatbang.calendar.SymbolButton;

public class PartyDateActivity extends Activity {
	...
	private static final int iDayCellSize = 67;
	...
	private DateWidgetDayCell.OnItemClick mOnDayCellClick = new DateWidgetDayCell.OnItemClick() {
		public void OnClick(DateWidgetDayCell item) {
			...
			resultIntent.putExtra("date", calSelected.getTimeInMillis());
